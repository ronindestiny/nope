...
export const PANCAKE_LINK = "https://pancakeswap.finance/swap?outputCurrency=0x5eA9Ee6336F36afc4B37b594b9E04ECd16644071"
...
export const HINT = [
    ...
    {
        title: "Do I have to transfer ownership of my NFT’s to CKNFT?",
        description: "No, they remain in your wallet the whole time. When you ‘store’ your NFT’s with us, we make a record of your wallet address. When you decide to retrieve your NFT,we send you all the $CKI you have earned, or airdrop you any bonuses throughout the year, we check your wallet. If the NFT is still there you will receive them. If you have sold it or transferred it to another wallet you are no longer eligible."
    },
    {
        title: "How much will I make?",
        description: "Up to you, the more you spend on storage the more $CKI tokens you will receive. The least is 1%, there is no maximum cap, but the price of $CKI will also impact your earnings."
    },
    {
    ...
    },
    {
        ...
        description: "Absolutely, our pre-sale focuses on those that strike first, they get rewarded."
    },
    {
        title: "What do you do with the funds?",
        description: "Nothing, we all like money. However we at CKI prefer keeping that number, not losing it."
    },
    {
        title: "Are you audited?",
        description: "In all seriousness the safety of your NFT’s and your funds is #1, 2 & 3 priority for this team. It’s not marketing, it’s not scaling, it’s security. We need new users to make this work, however we also need a watertight storage unit and that will come with audits. They take time, but they will happen. Guaranteed."
    },
    {
        title: "What blockchains are you on?",
        description: "We’re starting life on Binance (BSC). Next step is to branch into Ethereum, Afterwards we plan to take this contract to every network that allows smart contracts."
    },
    {
        title: "I can only see a black box where my NFT should be?",
        description: "Please, submit a ticket to our tech team, errors happen. However we work too hard on this project for small issues to cause investment fear."
    }
]