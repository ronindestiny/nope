        ...
        <div className="partner page-content">
          ...
          <Container>
            <div className="section-title" style={{ paddingTop: !headerAlert ? 35 : 60 }}>
              ...
              <p>The following companies / projects have partnered with us to allow their customers to generate yield through $CKI with their NFT&apos;s. Please do check them out!</p>
            </div>
